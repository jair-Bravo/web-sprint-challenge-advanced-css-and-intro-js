...
I would tell them to think back to a webside that they accessed on their phone and had a horizontal scroll bar of death and how that problem,with proper code, can be fixed with proper code thats responsive to different screen sizes.
Add Alt text to All images, use resizable text that doesnt break your code,make sure all content is accessible easily and structure H1,h2,h3 etc elements properly
2. Talk about 3 different things you can do to ensure your website is accessible. 

3. How would you explain the concept of a variable to someone new to programming?
It is a way of storing data that can be accessed and called upon
4. What is the purpose of using functions in code?
To make tasks or porcesses more effective and accessible and shorten task.
